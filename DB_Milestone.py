...
class DB_Milestone:
    """
        This represents DB_Milestone as a database operating class for github.Milestone.Milestone
    """
    ...
    def __init__(self, milestone, repo, db):
    ...
    def save(self):
        try:
            ...
            D = [(a,v) for (a, v) in self.milestone.__dict__.iteritems() if \
    ...
    def exist(self):
        try:
            ...
            sql = "select count(*) from %s where id=%d;"%(self.table, self.milestone.id)
