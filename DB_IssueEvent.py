...
class DB_IssueEvent:
    """
        This class represents DB_IssueEvent as a database operating class for github.IssueEvent.IssueEvent
    """
    ...
    def __init__(self, event, issue, db):
        self.event = event
        self.issue = issue
        self.db = db
    ...
    def exist(self):
        try:
            ...
            sql = "select count(*) from %s where id=%d;"%(self.table, self.event.id)
