...
class DB_GitCommit_Parentship:
    """
        This class represents DB_GitCommit_Parentship as a class describles the parent-child relationship between \
        github.GitCommit.GitCommit s
    """

    parent = None
    child = None
    db = None
    table = "GitCommit_Parentship"
